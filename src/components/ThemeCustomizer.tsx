...
export default function ThemeCustomizer({ config, onChange, watermarkRemoved, onOpenStarModal }: ThemeCustomizerProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-xs font-medium text-body">Font Size</label>
        <div className="flex items-center gap-2">
          ...
          />
          <span className="font-mono text-xs text-mute w-8 text-right">
            {config.fontSize}
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-xs font-medium text-body">Line Height</label>
        <div className="flex items-center gap-2">
          <input
            type="range"
            min={1}
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-xs font-medium text-body">Padding</label>
        <div className="flex items-center gap-2">
          <input
            type="range"
            min={8}
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-xs font-medium text-body">Border Radius</label>
        <div className="flex items-center gap-2">
          <input
            type="range"
            min={0}
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-xs font-medium text-body">Shadow Intensity</label>
        <div className="flex items-center gap-2">
          <input
            type="range"
            min={0}
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-xs font-medium text-body">Window Width (px)</label>
        <div className="flex items-center gap-2">
          <input
            type="range"
            min={320}
          ...
          <input
            ...
            className="w-16 h-8 px-2 text-xs font-mono bg-canvas border border-hairline rounded-md text-ink text-center focus:outline-none focus:border-hairline-strong"
          />
        </div>
      </div>

      <div className="flex flex-col gap-1.5">
        <label className="text-xs font-medium text-body">Window Height (px)</label>
        <div className="flex items-center gap-2">
          <input
            type="range"
            min={100}
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-xs font-medium text-body">Window Title</label>
        <input
          type="text"
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-xs font-medium text-body">Custom Prompt</label>
        <input
          type="text"
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-xs font-medium text-body">Prompt Style</label>
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-xs font-medium text-body">Cursor Style</label>
        <div className="flex gap-1.5">
          {(['block', 'underline', 'bar', 'none'] as CursorStyle[]).map((cs) => (
            <button
              ...
              className={`h-7 px-2.5 text-xs rounded-md border transition-colors capitalize ${
      ...
      {watermarkRemoved ? (
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2.5 cursor-pointer select-none">
            <input
              ...
              className="w-4 h-4 rounded border-hairline text-ink accent-ink focus:ring-0 cursor-pointer"
            />
            <span className="text-xs text-body">Watermark</span>
          </label>
          <span className="flex items-center gap-1 text-xs text-warning-deep bg-warning-soft rounded-full px-2 py-0.5">
            <span>⭐</span>
            <span>Starred</span>
          </span>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center gap-2.5 px-0.5 py-1.5 text-xs text-body hover:text-ink transition-colors text-left"
        >
          <span className="text-sm">⭐</span>
          <span>Remove watermark — star on GitHub</span>
        </button>
      )}
      ...
      <div className="flex items-center gap-2.5">
        <label className="text-xs font-medium text-body cursor-pointer" htmlFor="darkModeToggle">
          Dark Mode
        </label>
        <button
          id="darkModeToggle"
